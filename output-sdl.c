...
void output_sdl (SDL_Surface *tileset, SDL_Surface *typeface, SDL_Surface *uisurf, SDL_Surface *screen, 
  ...
  struct SDL_Rect dst_line_rect;
  dst_line_rect.x=TILE_WIDTH + 75*TYPE_WIDTH/2 - line_width/2;
  dst_line_rect.y=screen_y + (TYPE_HEIGHT*5/2);
  dst_line_rect.w=line_width;
  dst_line_rect.h=1;
